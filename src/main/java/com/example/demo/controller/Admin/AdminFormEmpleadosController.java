...
public class AdminFormEmpleadosController {
    ...
    public void initialize() {
        ...
        validarCaracteres(txtNombre);
        validarCaracteres(txtApellido);
    ...
    private void validarCaracteres(TextField valor) {


        valor.setTextFormatter(new TextFormatter<>(change ->
                (change.getControlNewText().matches("[a-z,A-Z]*")) ? change : null));

        valor.setTextFormatter(new TextFormatter<>(new DefaultStringConverter(), null, change -> {
